    ...
    <div className="min-h-screen" style={{ background: '#0f0c07' }}>
      ...
      <section className="relative overflow-hidden" style={{ minHeight: '92vh', display: 'flex', alignItems: 'center' }}>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32 w-full">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="text-center">
            ...
            {/* Subheading */}
            <p className="text-lg md:text-xl max-w-2xl mx-auto mb-10" style={{ color: 'rgba(255,255,255,0.7)', lineHeight: '1.8' }}>
          ...
          <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.3 }}
            ...
            {[
              ...
              <div key={i} className="text-center p-4 rounded-2xl"
                ...
                <div className="text-xs mt-0.5" style={{ color: 'rgba(255,255,255,0.4)', textTransform: 'uppercase', letterSpacing: '0.05em' }}>{stat.label}</div>
              </div>
            ))}
          </motion.div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="mt-1 text-sm" style={{ color: 'rgba(255,255,255,0.4)' }}>Select your grade to browse Mathematics lessons</p>
          </div>
          <Link to={createPageUrl('Categories')}
            className="text-sm flex items-center gap-1 font-semibold transition-all hover:opacity-80"
            style={{ color: GOLD }}>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="mt-1 text-sm" style={{ color: 'rgba(255,255,255,0.4)' }}>Recently uploaded video lessons</p>
            </div>
            <Link to={createPageUrl('Categories')}
              className="text-sm flex items-center gap-1 font-semibold transition-all hover:opacity-80"
              style={{ color: GOLD }}>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="relative overflow-hidden rounded-3xl p-8 md:p-12"
          ...
          <div className="absolute top-0 right-0 w-64 h-64 rounded-full blur-3xl" style={{ background: 'rgba(245,200,66,0.08)' }} />
          <div className="relative flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            {user ? (
              <Link to={createPageUrl('Pricing')}>
                <button className="px-8 h-12 rounded-2xl font-bold text-black text-base flex items-center gap-2 whitespace-nowrap transition-all hover:-translate-y-0.5"
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <Link to={createPageUrl('Login')}>
                  <button className="px-8 h-12 rounded-2xl font-semibold text-base flex items-center gap-2 whitespace-nowrap transition-all hover:-translate-y-0.5"
